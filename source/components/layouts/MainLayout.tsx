...
import PlaylistDetail from '../playlist/PlaylistDetail.tsx';
import LocalMusicLayout from './LocalMusicLayout.tsx';
...
function MainLayout() {
	...
	const goToLocalMusic = useCallback(() => {
		dispatch({category: 'NAVIGATE', view: VIEW.LOCAL_MUSIC});
	}, [dispatch]);
	...
	useKeyBinding(KEYBINDINGS.LOCAL_MUSIC_VIEW, goToLocalMusic);
	...
	const currentView = useMemo(() => {
		...
		switch (navState.currentView) {
			...
			case 'playlist_detail':
				return <PlaylistDetail key="playlist_detail" />;

			case 'local_music':
				return <LocalMusicLayout key="local_music" />;
